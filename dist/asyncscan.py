...
cmd_asyncScan = (
    conquest.createCommand(name="asyncscan", description="Scan target systems for open ports (async).", example="asyncscan 192.168.168.0/24 1-1000,8443",
            ...
            .addFlagInt("--timeout", "timeout", "Timeout between checks in seconds (default: 0).")
            ...
            .setHandler(lambda agentId, cmdline, args: (
                ...
                params := conquest.bof_pack("zziii", [
                    ...
                    timeout,                    # i: Timeout between checks
